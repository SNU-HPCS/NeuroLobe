...
class AbstractLif(torch.nn.Module):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.neuron_params is not None:
            self.neuron = lif.Neuron(**self.neuron_params)
...
class Input(AbstractLif, base.AbstractInput):
    def __init__(self, *args, **kwargs):
...
class Affine(AbstractLif, base.AbstractAffine):
    def __init__(self, *args, **kwargs):
...
class Dense(AbstractLif, base.AbstractDense):
    def __init__(self, *args, **kwargs):
...
class Conv(AbstractLif, base.AbstractConv):
    def __init__(self, *args, **kwargs):
...
class ConvT(AbstractLif, base.AbstractConvT):
    def __init__(self, *args, **kwargs):
...
class Pool(AbstractLif, base.AbstractPool):
    def __init__(self, *args, **kwargs):
...
class Unpool(AbstractLif, base.AbstractUnpool):
    def __init__(self, *args, **kwargs):
...
class KWTA(AbstractLif, base.AbstractKWTA):
    def __init__(self, *args, **kwargs):
...
class Recurrent(AbstractLif, base.AbstractRecurrent):
    def __init__(self, *args, **kwargs):

...
class Dense(torch.torch.nn.Conv3d, GenericLayer):
    ...
    def __init__(
        ...
        weight_scale=1, weight_norm=False, pre_hook_fx=None, bias = False
    ):
        """ """
        ...
        super(Dense, self).__init__(
            in_channels, out_channels, kernel, bias=bias
        )
    ...
    def forward(self, input):
        ...
        if len(input.shape) == 3:
            ...
            self.comp_result =  F.conv3d(  # bias does not need pre_hook_fx. Its disabled

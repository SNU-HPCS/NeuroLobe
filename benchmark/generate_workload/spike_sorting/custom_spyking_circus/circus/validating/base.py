...
def main(params, nb_cpu, nb_gpu, us_gpu):    
    ...
    if chan == 'auto':
        ...
        if USE_OLD_VERSION:
            ...
            juxta_spike_times_selection = numpy.ones(juxta_spikes.shape[2], dtype=numpy.bool_)
    ...
    if comm.rank == 0:
        ...
        if MODE == 'custom':
            ...
            sc_contingency_matrices = numpy.zeros((n_temp, 2, 2), dtype=numpy.int_)
            ...
            if 0 < len(temp_match) and greedy_mode:
                ...
                while find_next:
                    ...
                    local_sc_contingency_matrices = numpy.zeros((nb_temps, 2, 2), dtype=numpy.int_)
    ...
    if comm.Get_rank() == 0:
        ...
        selection = numpy.array(scerror['selection'], dtype=numpy.int_)

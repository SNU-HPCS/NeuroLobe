...
if __name__ == '__main__':
    ...
    result_path = result_dir + "PC_EMULATE_" + str(target_cell_num) + "_" + str(data_mode) + "_" + str(bin_width) + "_" + str(corr_period)
    ...
    # Set conn_list to dict
    conn_dict = {}
    for index in range(len(conn_list)):
        src, dst = conn_list[index]
        conn_dict[(src, dst)] = index
    ...
    # Make random connection between neurons
    create_connections(cell_num, conn_list, conn_dict)

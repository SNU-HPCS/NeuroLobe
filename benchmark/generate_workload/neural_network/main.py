...
parser.add_argument('--inference', type=int, dest='inference', default=False, help='inference')
...
result_dir="../../dataset/"
if fr_scale == 1:
    result_path = result_dir + str(model_name) + "_" + str(target_cell_num) + "_" + str(bin_width_ms)
else:
...
if model_name == "FC":
    if split == 1:
        ...
        assert(0)
elif "Slayer" in model_name and "FCSNN" in model_name:
    if split == 1:

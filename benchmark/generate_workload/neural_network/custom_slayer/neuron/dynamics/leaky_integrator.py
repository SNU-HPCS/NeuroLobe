...
import leaky_integrator_float_cuda
import leaky_integrator_cuda
...
class Accelerated:
    ...
    def leaky_integrator():
        if quantconfig.QUANTIZE:
            return leaky_integrator_cuda
        else:
            return leaky_integrator_float_cuda
        ...
        #        )
        #    else:
        #        print("TEST7", __file__)
        #        Accelerated.module = load(
        #            name='dynamics',
        #            sources=[
        #                os.path.dirname(os.path.abspath(__file__))
        #                + '/leaky_integrator_float.cu'
        #            ],
        #        )
        #        print(Accelerated.module)

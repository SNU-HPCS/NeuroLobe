...
class Neuron(torch.nn.Module):
    ...
    def __init__(
        ...
        self.shape = None
        self.p_scale = quantconfig.p_scale
        if quantconfig.QUANTIZE:
            ...
            self.w_scale = quantconfig.w_scale
            self.s_scale = quantconfig.s_scale
            self._threshold = threshold

        self.tau_rho = tau_grad * self._threshold
        #self.tau_rho = tau_grad
    ...
    def v_th_mant(self):
        ...
        if quantconfig.QUANTIZE:
            ...
            return self.threshold * self.w_scale

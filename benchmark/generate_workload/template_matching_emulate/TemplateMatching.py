...
if __name__ == '__main__':
    ...
    result_path = result_dir + "TM_EMULATE_" + str(target_cell_num) + "_" + str(data_mode) + "_" + str(bin_width)

    print("=====================================")
    print("duration:", duration)
    print("cell num:", cell_num)
    print("template num:", len(temp_to_use))
    print("duplicate num:", duplicate_num)
    print("target cell num:", target_cell_num)
    print("bin width:", bin_width, "(ms)")
    print("template window:", template_window, "(ts)")
    ...
    p_t = (template_window // bin_width) * N_tm
    print(template_window, N_tm, bin_width, p_t)

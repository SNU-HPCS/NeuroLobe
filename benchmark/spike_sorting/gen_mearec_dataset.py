...
# sim_exc_num = properties.getint('general', 'exc_num')
# sim_inh_num = properties.getint('general', 'inh_num')
...
assert(len(sys.argv) == 2), "sim_elec_num should be specified like 200, 400, 800, 1600"
sim_elec_num = int(sys.argv[1])

# Check params
########################
print(f"sim_mode : {sim_mode}")
# print(f"sim_neu_num : {sim_exc_num + sim_inh_num}")
# print(f"sim_exc_num : {sim_exc_num}")
# print(f"sim_inh_num : {sim_inh_num}")
# print(f"sim_temp_num : {sim_temp_num}")
...
# save recordings in h5 format
    mr.save_recording_generator(recgen, filename=f'data/{probe_name}_{num_neurons}_{sim_duration}s_recordings_16x.h5')

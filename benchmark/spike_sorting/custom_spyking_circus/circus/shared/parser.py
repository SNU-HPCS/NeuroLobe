...
class CircusParser(object):
    ...
    __default_values__ = [['fitting', 'amp_auto', 'bool', 'True'],
                          ...
                          #['fitting', 'batch_second', 'float', 0.1],
                          ['fitting', 'two_components', 'bool', 'False'],
                          ['fitting', 'auto_nb_chances', 'bool', 'False'],
                          ['fitting', 'sparse_thresh', 'float', '0'], # changed! since modified algorithm assume densified matrix
                          ...
                          ['fitting', 'real_time', 'bool', 'False'],
                          ['fitting', 'spatial_sparse', 'bool', 'False'],
                          ['fitting', 'valid_multiple', 'bool', 'False'],
                          ['fitting', 'duration', 'int', '1000'],
                          ['clustering', 'radius', 'float', '50.0'],
                          ['clustering', 'radius_en', 'bool', 'False'],
                          ['clustering', 'sparsify', 'float', '0.25'], # changed!
    ...
    __extra_values__ = [['fitting', 'nb_chances', 'float', '3'],
                        ...
                        #['clustering', 'sparsify', 'float', '0.15'], # changed!

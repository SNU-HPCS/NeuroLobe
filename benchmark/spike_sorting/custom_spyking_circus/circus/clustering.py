            ...
            for p in search_peaks:
                ...
                for group in numpy.unique(loc_clusters):
                    ...
                    if comp_templates:
                        ...
                        # sum electrodes number
                        # analysis_file.write(f"{num_prune} electrodes pruned out of {elec_in_template}, {elec_in_pruned_template} electrodes left\n")
                        # total_elec_in_template += elec_in_template
                        # total_elec_in_pruned_template += elec_in_pruned_template

                        #not_to_delete = numpy.where(local_stds / stds[indices] >= sparsify)[0]

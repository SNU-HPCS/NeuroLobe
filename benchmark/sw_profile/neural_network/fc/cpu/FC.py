...
def FC_cpu(M_t, spike_per_ts, weight_per_spike,
    ...
    for iteration in range(num_iter):
        ...
        for t in range(M_t): # iterate over 600ms
            ...
            inference.FC_cpu_inner(spike_list, spike_weight, conn_mem_1_weight_transpose, conn_mem_2_weight_transpose, hidden_vector, output_vector, weight_list_1, weight_list_2, I_t_vector1, I_t_vector2, spike_buf, spike_sum, i_dim, h_dim, o_dim, t, num_spikes, num_thread, bin_width)
